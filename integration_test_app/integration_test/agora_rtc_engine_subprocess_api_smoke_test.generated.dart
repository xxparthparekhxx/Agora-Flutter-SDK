...
void rtcEngineSubProcessSmokeTestCases() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final LocalAccessPointConfiguration config =
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final LowLightEnhanceOptions option = LowLightEnhanceOptions(
        mode: optionMode,
        level: optionLevel,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final VideoDenoiserOptions option = VideoDenoiserOptions(
        mode: optionMode,
        level: optionLevel,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final ColorEnhanceOptions option = ColorEnhanceOptions(
