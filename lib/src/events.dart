...
///  interface to send event notifications to your app. Your app can get those notifications through methods that inherit this interface.
///
///
class RtcEngineEventHandler {
  ...
  /* callback-engine-localVideoStateChanged */
  ...
  /* callback-engine-requestAudioFileInfoCallback */
  ...
  /* callback-engine-firstRemoteVideoFrame */
  @deprecated
  ...
  /* callback-engine-firstLocalAudioFramePublished */
...
///  to send
/// RtcChannel
///  event notifications to your app.
///
///
class RtcChannelEventHandler {
  ///
  /// Reports the warning code of
  /// RtcChannel
  /// .
  ///
  ///
  ...
  ///
  /// Occurs when the local user receives
  /// Metadata
  /// .
  ///
  ///
